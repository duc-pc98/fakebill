      ...
      <div class="row justify-content-center">
        <div class="col-md-5">
          ...
          <form id="td-vietcombank" method="POST">
            <input name="forbank" value="vietcombank" hidden="">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <textarea type="text" id="noidung" name="noidung" required class="form-control" placeholder="DICHVUVN chuyển tiền"></textarea>
              </div>
            </div>
        ...
        setTimeout(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#download-img').html('<a href="data:image/jpeg;base64,' + response + '" download="DICHVUVN.jpg" class="btn btn-success">Tải Bill Xuống</a><br/><br/>');
